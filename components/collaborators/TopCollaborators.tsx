    ...
    <Card className="bg-[#0c1322] border-[#12314a] text-white h-full">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400">
          <span className="px-2 py-1 rounded-full border border-[#1a2c45] bg-[#0b1424]">
            All orgs
          </span>
          <span className="px-2 py-1 rounded-full border border-[#1a2c45] bg-[#0b1424]">
            All repos
        ...
        <>
            ...
            {list.map((c, idx) => (
              <a
                ...
                className={`flex items-center gap-3 p-3 rounded-xl border transition-colors ${
                  idx === 1
                    ? "border-cyan-500/70 bg-[#0f1829] shadow-[0_0_0_1px_rgba(34,211,238,0.4)]"
                    : "border-[#1a2c45] bg-[#0f1829] hover:border-cyan-500/60"
                }`}
              >
                <img
                  src={c.avatar_url}
          ...
          <div className="mt-4 text-center text-xs text-gray-400">
            ...
            <span className="text-cyan-300 font-mono">
              {Math.max(total, list.length || 0) || 0}
            </span>{" "}
